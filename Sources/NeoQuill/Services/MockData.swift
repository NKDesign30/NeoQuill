...
enum MockData {
    ...
    static let activeMeeting = MeetingDetail(
        ...
        wordCount: 3142,
        participants: [
            .init(id: "NK", name: "Niko Knez",     role: "NK Design",    colorHex: 0x2EAB73, spoke: "14m 02s"),
        ...
        tasks: [
            ...
            .init(id: "t2", who: "NK", task: "NeoBar-Beta-Rollout auf KW 19 verschieben, Stakeholder informieren", due: "02. Mai", status: .open),
            ...
            .init(id: "t5", who: "NK", task: "Q2-Roadmap im All-Hands vorstellen",                                  due: "30. Apr.", status: .done),
        ],
        chapters: [
        ...
        transcript: [
            .init(who: "NK", timestamp: "00:14", body: "Gut, dann lass uns starten. Heute geht es um die Q2-Roadmap — ich würde mit dem Pricing-Test anfangen, wenn das passt."),
            ...
            .init(who: "NK", timestamp: "00:48", body: "Klingt gut. Auswertung dann am 16.?", highlight: true),
            ...
            .init(who: "NK", timestamp: "01:19", body: "Lass uns das als Risiko tracken. Wenn bis KW 17 nichts da ist, eskalieren wir."),
            .init(who: "NK", timestamp: "01:34", body: "Nächster Punkt — WhisperKit. Bleiben wir bei on-device?"),
            ...
            .init(who: "NK", timestamp: "02:08", body: "Einverstanden. Damit ist die Architektur klar — Sarah, magst du das in einem ADR festhalten?", highlight: true),
            .init(who: "SE", timestamp: "02:21", body: "Mache ich. Bis 8. Mai im Notion."),
            .init(who: "TM", timestamp: "02:33", body: "Und NeoBar-Beta?"),
            .init(who: "NK", timestamp: "02:38", body: "Schaffen wir nicht in dieser KW — verschieben wir auf KW 19. Ich informiere die Stakeholder."),
        ]
    )
    ...
    static let liveSession = LiveSession(
        ...
        lines: [
            .init(who: "NK", timestamp: "00:04", body: "Gut, dann starten wir. Zwei Punkte heute — Pricing-Status und das Beta-Rollout."),
            .init(who: "SE", timestamp: "00:12", body: "Pricing läuft sauber, 11 % über Plan. Ich würde verlängern."),
            .init(who: "NK", timestamp: "00:21", body: "Bis Mitte Mai?"),
            ...
            .init(who: "NK", timestamp: "00:41", body: "Wir tracken das als Risiko. Sarah, kannst du WhisperKit dokumentieren?"),
